...
const TutorDashboard = () => {
  ...
  const tabs = [
    ...
    { id: 'supervise', label: 'Supervise', icon: <import { FiGrid, FiUsers, FiLogOut, FiMenu, FiX, FiChevronLeft, FiUserPlus,FiClipboard,FiEye,FiUserCheck,FiCheckCircle ,FiTarget   } from 'react-icons/fi'
  /> },
