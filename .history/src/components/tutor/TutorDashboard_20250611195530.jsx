...
import { FiGrid, FiUsers, FiLogOut, FiMenu, FiX, FiChevronLeft, FiUserPlus,FiClipboard,FiEye,FiUserCheck,FiCheckCircle   } from 'react-icons/fi'
...
const TutorDashboard = () => {
  ...
  const tabs = [
    ...
    { id: 'supervise', label: 'Supervise', icon: <FiClipboard  /> },
