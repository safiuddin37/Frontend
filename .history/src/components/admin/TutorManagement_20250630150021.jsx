...
// No hardcoded API URLs found in this file. All API calls use the API axios instance, which should be configured with the .env base URL.
// If you ever see a direct URL like 'http://...' or 'https://...', replace it with `${import.meta.env.VITE_API_URL}`.
